...
/**
 * useLanguage — active locale code + setter. For toggles, switchers, and any UI
 * that needs to react to the language itself rather than the translated copy.
 */
 ...
 * instead of reading hardcoded copy, so swapping the language re-renders every
